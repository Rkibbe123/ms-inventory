...
def generate_cli_device_login_script(output_dir, tenant, subscription):
    ...
    script_parts.extend([
        ...
        "    $paramString = \"-ReportDir '$reportDir' -ReportName '$reportName' -TenantID '$tenantId' -SubscriptionID '$subscriptionId' -SkipDiagram -Debug\"",
        ...
        "    try {",
        "        $minimalExpression = \"Invoke-ARI -ReportDir '$reportDir' -SkipDiagram -Debug\"",
        ...
        "        try {",
        "            & 'Invoke-ARI' -ReportDir $reportDir -Debug",
